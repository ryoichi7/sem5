...
VALUES
    ('Товары для дома', 'Компания, специализирующаяся на производстве товаров для дома.'),
    ('Электроника Плюс', 'Современная электроника и аксессуары.'),
    ('Мир Книг', 'Издательство и распространение книг всех жанров.'),
    ('Одежда XXI века', 'Производство одежды для всех возрастов.');

INSERT INTO products (category_id, company_id, product_name, description, price, stock_quantity)
VALUES
    (1, 4, 'Носки', 'Мягкие и теплые носки', 199.99, 100),
    (2, 1, 'Табуретка', 'Деревянная табуретка для кухни', 599.99, 50),
    (3, 2, 'Смартфон', 'Современный смартфон с большим экраном', 29999.99, 30),
    (4, 3, 'Книга: Война и мир', 'Роман Льва Толстого', 499.99, 20),
    (5, 1, 'Хлеб', 'Свежий хлеб из пекарни', 49.99, 200);

-- Вставка примеров данных в таблицу отзывов
INSERT INTO reviews (user_id, product_id, rating, comment)
VALUES
    (1, 1, 5, 'Очень хорошие носки, рекомендую!'),
    (2, 3, 4, 'Смартфон отличный, но дороговат'),
...
-- Вставка примеров данных в таблицу ответов на отзывы
INSERT INTO replies (review_id, company_id, reply_text)
VALUES
    (1, 4, 'Спасибо за отзыв, рады, что вам понравилось!'),
    (2, 2, 'Мы стараемся улучшить качество наших товаров.'),
    (3, 3, 'Спасибо, что выбрали наше издательство!');